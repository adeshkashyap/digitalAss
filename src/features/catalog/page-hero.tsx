...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-border">
      ...
      <div className="grid-backdrop pointer-events-none absolute inset-0 opacity-40 [mask-image:linear-gradient(to_bottom,black,transparent)]" aria-hidden />
      <div className="shell relative py-10 lg:py-16">
        <Breadcrumbs items={crumbs} />
        <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
          <div className="min-w-0 max-w-3xl">
            {eyebrow && <p className="eyebrow mb-3">{eyebrow}</p>}
            <h1 className="font-display text-3xl font-semibold sm:text-[2.75rem]">
              {title}
            </h1>
            {description && (
